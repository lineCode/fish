...
all: $(LUA_STATICLIB) $(PBC_STATICLIB) $(LPEG_SO) $(CJSON_SO) $(LFS_SO) $(PROTOBUF_SO) $(BSON_STATICLIB) $(CORE_STATICLIB) $(FISH)
...
clean :
	...
	rm -rf $(LIBS_DIR)/libbson.a $(BSON_INC)/*.o
